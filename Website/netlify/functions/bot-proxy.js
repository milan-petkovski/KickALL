...
exports.handler = async (event) => {
  ...
  const ALLOWED_PATHS = ['/api/channels', '/api/kick/logs', '/api/kick/reload', '/api/kick/test-ping', '/api/kick/send-message', '/api/kick/check-moderator', '/api/kick/channel', '/api/global-logout', '/api/check-logout', '/api/kick/update-session'];
