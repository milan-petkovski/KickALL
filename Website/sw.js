...
const ASSETS_TO_CACHE = [
  ...
  '/css/style.css',
  '/css/dashboard.css',
  '/js/dist/config.min.js',
  '/js/dist/app.min.js',
  '/js/dist/dashboard.min.js',
  '/js/dist/mobile-optimization.min.js',
  '/js/dist/toast.min.js',
  '/js/dist/data-layer.min.js',
  '/js/dist/route-tracking.min.js',
  '/js/dist/consent-banner.min.js',
  '/js/dist/analytics.min.js',
  '/assets/logo.webp',
  '/assets/kickall.webp',
  '/assets/favicon.ico',
  '/locales/sr.json',
